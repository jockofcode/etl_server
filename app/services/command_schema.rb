  ...
  SCHEMAS = {
    "transform_data" => {
      ...
      fields: {
        ...
        "next"       => { type: "string",  required: false, description: "Next node key" }
      }
    },
    "check_data" => {
      ...
      fields: {
        ...
        "on_success" => { type: "string",  required: true,  description: "Next node key when condition is truthy" },
        "on_failure" => { type: "string",  required: true,  description: "Next node key when condition is falsy" }
      }
    },
    "for_each_item" => {
      ...
      fields: {
        ...
        "next"       => { type: "string",  required: false, description: "Next node key after all iterations" }
      }
    },
